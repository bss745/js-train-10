...
function customObjectFromEntries(entries) {
  ...
  const arr30 = Object.fromEntries(arr3);
  return arr30;
}
...
function checkProperty(obj, prop) {
  ...
  const arr4 = obj.hasOwnProperty(prop);
...
function extendAndFreezeObject(obj1, obj2) {
  ...
  const arr4 = Object.assign(obj1, obj2);
...
function checkOwnership(obj1, obj2, key) {
  ...
  //   const cc1 = obj1.hasOwnProperty(key);
  //   const cc2 = obj2.hasOwnProperty(key);
...
function getObjectValuesSum(obj) {
  ...
  const sss = Object.values(obj);
  const sum = sss.reduce(
